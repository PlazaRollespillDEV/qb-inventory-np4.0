    ...
    $.post(
        ...
        function(data) {
            ...
            $(".weapon-attachments-container-details").html(
                '<span style="font-weight: 400; letter-spacing: .1vh;">Serienummer</span><br> ' +
...
// var MarkedUsePart = "<p><strong>Worth: </strong><span> kr " + itemData.info.worth + "</span></p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>";
var MarkedUsePart = "<span style=\"background-color: #333333; padding: 5px;\"><b> <i class='fas fa-user-tag'></i>  kr " + itemData.info.worth + "</span></p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>";
...
(() => {
    ...
    Inventory.itemBox = function(data) {
        ...
        var type = "🤚 " + data.itemAmount + "x";
        if (data.type == "add") {
            type = "➕ " + data.itemAmount + "x";
